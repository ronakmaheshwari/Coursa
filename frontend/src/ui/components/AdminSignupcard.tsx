...
export default function AdminSignupCard({ type }: { type: "signup" | "signin" }) {
    ...
    return (
        <div className="flex flex-col p-6 w-full max-w-md rounded-2xl shadow-lg bg-white border border-gray-200">
            ...
            <p className="mt-4 text-center">
                ...
                <button className="font-medium text-indigo-600 hover:text-indigo-700 transition" onClick={()=>navigate(type === "signup" ? "/admin/signin" : "/admin/signup")} >
